...
export default function Checkout() {
    ...
    useEffect(() => {
        ...
        apiServices.getCart(data)
            .then((data) => {
                ...
                // const productIds = data?.data?.items?.map(item => item.productId?._id) || [];
    ...
    const handleData = async (e) => {
        ...
        try {
            const response = await apiServices.MakeOrder(data);
                                                    ...
                                                    <form >
                                                        <div>
                                                            ...
                                                            <div className="row">
                                                                ...
                                                                <div className="col-lg-4">
                                                                    <div className="mb-4 mb-lg-0">
                                                                        <label className="form-label" for="billing-city">State</label>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th scope="row checkout-img">
                                                        <img src={BASE_URL_IMG + item.productId?.Image} alt="product-img" title="product-img" className="avatar-lg rounded" />
                                                    </th>
                                                    <td>
                                                        <h5 className="font-size-16 text-truncate"><a href="#" className="text-dark">{item.productId.productname}</a></h5>
                                                        ...
                                                        <p className="text-muted mb-0 mt-1">  $ {parseFloat(item.productId.price) || 0} x {item.quantity}</p>
                                                    </td>
                                                    <td>$ {(parseFloat(item.productId.price) || 0) * item.quantity}</td>
                                                </tr>
