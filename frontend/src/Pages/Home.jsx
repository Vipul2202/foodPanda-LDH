  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${
            BASE_URL_IMG + (banner.length ? banner[0].Image : "")
          })`,
        }}
      >
    ...
    <!-- Product Start --> */}
      <div className="container-xxl bg-light my-6 py-6 pt-0">
        <div className="container">
          <div
            className="bg-gradient-to-r from-purple-500 via-orange-500 via-black to-red-500 text-light rounded-bottom p-5 my-6 mt-0 wow fadeInUp"
            data-wow-delay="0.1s"
          >
