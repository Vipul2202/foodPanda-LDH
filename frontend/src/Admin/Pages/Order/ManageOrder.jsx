...
export default function ManageOrder({ setIsActive, isActive }) {
    ...
    const actionTemplate = (rowData) => {
        return (
            <div className="d-flex justify-content-center gap-3">
                <Link to={`/admin/update-order/${rowData?._id}`}>
                    <Button
                        icon="pi pi-pencil"
        ...
        <main id="main" className={`main mainWrapper ${isActive === true && 'active'}`}>
            ...
            <div className="card">
                ...
                {/* column start  */} 
                    ...
                    <Column field='billingAddress.postalCode' sortable  header="Zip"  ></Column>
