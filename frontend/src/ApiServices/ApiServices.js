...
class apiServices {
  ...
  addBanner(data) {
    ...
    return axios.post(BASE_URL + "addBanner", data, { headers: header });
  }
  getsingleBanner(data) {
    ...
    return axios.post(BASE_URL + "getsingleBanner", data, { headers: header });
  }
  updateBanner(data) {
    const token = sessionStorage.getItem("token");
    const header = {
    ...
    return axios.post(BASE_URL + "updateBanner", data, { headers: header });
  }
  getallBanner(data) {
    const token = sessionStorage.getItem("token");
    const header = {
    ...
    return axios.post(BASE_URL + "getallBanner", data, { headers: header });
  }
  deleteBanner(data) {
    const token = sessionStorage.getItem("token");
    const header = {
    ...
    return axios.post(BASE_URL + "deleteBanner", data, { headers: header });
  }
